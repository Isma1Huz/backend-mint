            ...
            <div class="row px-1 container-div">
                <div class="col-12 text-div col-md-6 center-element py-4">
                    <div class="text-center">
                        <h1 class="text-white text-uppercase header-text">{{ translate('Welcome to '. Helpers::get_business_settings('business_name') ?? translate('mynt')) }}</h1>
                        <hr class="bg-white" style="width: 40%">
                        <div class="text-white text-uppercase">
                            <span style="width: 50%;display: inline-block">
                                {{ translate((Helpers::get_business_settings('business_name') ?? translate('mynt')) . ' is a secured and user-friendly digital wallet') }}
                            </span>
                        </div>
                    </div>
                </div>
